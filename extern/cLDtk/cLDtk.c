...
struct fieldInstances fieldInstances;
struct fieldInstances *fieldInstances_details_ptr = NULL;
struct fieldInstances *fieldInstances_points_ptr = NULL;
struct fieldInstances *fieldInstances_floats_ptr = NULL;
struct fieldInstances *fieldInstances_ints_ptr = NULL;
struct fieldInstances *fieldInstances_strings_ptr = NULL;

struct entityInstances entityInstances;
struct entityInstances *entityInstances_details_ptr = NULL;
struct entityInstances *fieldInstances_data_ptr = NULL;

struct layerInstances layerInstances;
struct layerInstances *layerInstances_details_ptr = NULL;
struct layerInstances *autoTiles_data_ptr = NULL;
struct layerInstances *gridTiles_data_ptr = NULL;
struct layerInstances *entityInstances_data_ptr = NULL;
struct layerInstances *integerGrid_data_ptr = NULL;

struct levels levels;
struct levels *levels_details_ptr = NULL;
struct levels *layers_data_ptr = NULL;

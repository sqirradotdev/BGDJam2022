...
//----------------------------------------------------------------
    ...
    extern struct enums* enums_details_ptr;
    //----------------------------------------------------------------
    ...
    extern struct fieldInstances fieldInstances;
    extern struct fieldInstances *fieldInstances_details_ptr;
    extern struct fieldInstances *fieldInstances_points_ptr;
    extern struct fieldInstances *fieldInstances_floats_ptr;
    extern struct fieldInstances *fieldInstances_ints_ptr;
    extern struct fieldInstances *fieldInstances_strings_ptr;
    //----------------------------------------------------------------
    ...
    extern struct entityInstances entityInstances;
    extern struct entityInstances *entityInstances_details_ptr;
    extern struct entityInstances *fieldInstances_data_ptr;
    //----------------------------------------------------------------
    ...
    extern struct layerInstances layerInstances;
    extern struct layerInstances *layerInstances_details_ptr;
    extern struct layerInstances *autoTiles_data_ptr;
    extern struct layerInstances *gridTiles_data_ptr;
    extern struct layerInstances *entityInstances_data_ptr;
    extern struct layerInstances *integerGrid_data_ptr;
    //----------------------------------------------------------------
    ...
    extern struct levels *levels_details_ptr;
    extern struct levels *layers_data_ptr;
    extern struct levels *tilesets_data_ptr;
    extern struct levels *enums_data_ptr;
    //----------------------------------------------------------------
    ...
    extern struct file_detail file_detail;
    extern struct file_detail *file_details_ptr;
    extern struct file_detail *levels_data_ptr;
